  ...
  return (
    <TermsContainer>
      ...
      <p>
        ...
        of DoubtCo's Website, located at https://gradkit.vercel.app/course.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        GradKit for your own personal use subjected to restrictions set in these
      ...
      <p>
        ...
        DoubtCo does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of DoubtCo,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, DoubtCo shall not be liable for the
      ...
      <br />
      <p>
        You hereby grant DoubtCo a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of DoubtCo; and (d) the link is in
      ...
      <p>
        ...
        e-mail to DoubtCo. Please include your name, your organization name,
